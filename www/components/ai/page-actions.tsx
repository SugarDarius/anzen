...
type AiPlatform = 'chatgpt' | 'claude' | 'cursor' | 'v0' | 't3Chat' | 'scira'
...
const getPromptUrl = ({
  ...
  const prompt = `Read this Anzen (@sugardarius/anzen) documentation page: ${docUrl}, I want to ask questions about it.
...
type PopoverItem =
  | {
      type: 'action'
      platform: 'markdown' | 'github' | AiPlatform
      component: (url: string) => React.ReactNode
    }
  | {
      type: 'divider'
    }
