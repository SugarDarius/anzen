...
<Tabs defaultValue='route-handler' className='mt-6'>
  <TabsList className='mx-auto max-w-full overflow-x-auto'>
    <TabsTrigger value='route-handler' className='cursor-pointer'>Safe route handler</TabsTrigger>
...
<Tabs defaultValue='route-handler'>
  <TabsList className="mx-auto max-w-full overflow-x-auto'">
    <TabsTrigger value='route-handler' className='cursor-pointer'>Route Handler</TabsTrigger>
    <TabsTrigger value='server-components' className='cursor-pointer'>Page & Layout<Badge className="ml-1 px-1 text-[12px] py-0.5 leading-none">new</Badge></TabsTrigger>
  </TabsList>
  <TabsContent value='route-handler'>
...
#### 🧪 `experimental_slots?: string[]` (Layout only)
