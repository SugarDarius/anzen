...
<Cards>
  <Card title='createSafeServerAction' href='/docs/server-action'>
    Server actions — validation, auth, structured results, tagErr.
  </Card>
  <Card title='createSafeRouteHandler' href='/docs/route-handler'>
    Route handlers — segments, query, JSON or form body, auth.
  </Card>
  <Card title='createSafePageServerComponent' href='/docs/page-server-component'>
    Page Server Components — segments and search params.
  </Card>
  <Card title='createSafeLayoutServerComponent' href='/docs/layout-server-component'>
    Layout Server Components — children and optional parallel slots.
  </Card>
</Cards>
