---
title: createSafeLayoutServerComponent
...
>(
  ...
  layout: (ctx: SafeLayoutServerComponentContext<AC, TSegments, TSlots>) => Promise<React.ReactElement>
...
## Handler context (`SafeLayoutServerComponentContext`)
