---
title: createSafePageServerComponent
...
>(
  ...
  page: (ctx: SafePageServerComponentContext<AC, TSegments, TSearchParams>) => Promise<React.ReactElement>
): (props: { params: Awaitable<any>; searchParams: Awaitable<any> }) => Promise<React.ReactElement>
```
...
## Handler context (`SafePageServerComponentContext`)
