---
title: createSafeServerAction
description: API reference for the safe server action factory — validation, authorization, structured results, and tagErr.
icon: Zap
---
...
// With input schema
function createSafeServerAction<TOutput, TInput extends StandardSchemaV1, AC = undefined>(
...
## Handler context (`SafeServerActionContext`)
...
- [Get started](/docs/get-started) — tutorials for all surfaces
